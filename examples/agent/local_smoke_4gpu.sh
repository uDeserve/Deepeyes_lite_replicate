...
# 5) export LLM_AS_A_JUDGE_BASE="http(s)://your-openai-compatible-endpoint/v1"
# 6) export LLM_AS_A_JUDGE_API_KEY="your-api-key"
# 7) export LLM_AS_A_JUDGE_MODEL="qwen3.5-plus"
# 6) bash examples/agent/local_smoke_4gpu.sh

PROJECT_NAME="agent_vlagent_local"
EXPERIMENT_NAME="smoke_4gpu_subset512"
...
# Put Qwen2.5-VL-7B-Instruct under ${DEEPEYES_MODEL_DIR} first.
