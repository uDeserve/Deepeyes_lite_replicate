...
# 4卡冒烟安全配置（方案A：关闭chunked_prefill）
# 策略：关闭enable_chunked_prefill，避免vLLM v1的严格显存验证
#
# Usage:
...
# 8) bash examples/agent/local_smoke_4gpu_safe.sh

PROJECT_NAME="agent_vlagent_local"
EXPERIMENT_NAME="smoke_4gpu_safe"
